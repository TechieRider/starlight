---
title: Litlyx
description: A description on what Litlyx is and why it is needed.
---

Litlyx is a traffic analytics platfform. The platform is 100% GDPR compliant and was founded in Italy, Europe.

Installing Litlyx on a documentation platform results in statistics and understanding of the users reading the documentation.
...
![The dashboard inside a workspace in Litlyx](../../../assets/litlyxdashboard.png)
...
4. Click on the button *Generate Report*.
